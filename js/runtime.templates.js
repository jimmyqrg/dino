!(function () {
                ...
                function d(t) {
                    if (t.__jstcache) return t.__jstcache;
                    var e = t.getAttribute("jstcache");
                return e ? (t.__jstcache = C[e] || h(t)) : h(t);
                }
                function v(t, e) {
                    var n = document;
                    if (e) {
            ...
            (window.jstProcess = function (e, n) {
                // #region agent log
                fetch('http://127.0.0.1:7243/ingest/3cb9382d-42e8-4283-ad23-8a993d8d247c',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'js/runtime.templates.js:jstProcess',message:'called',data:{hasNode:!!n,hasContext:!!e},timestamp:Date.now(),sessionId:'debug-session',runId:'pre-fix',hypothesisId:'H3'})}).catch(()=>{});
                // #endregion agent log
                        var i = new u();
                        c(n),
                            (i.m = n
